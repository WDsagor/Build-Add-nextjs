        ...
        <div className=" absolute left-8 right-8 bottom-8 text-white md:left-12 md:bottom-12 lg:left-16 lg:right-16  grid grid-cols-2 gap-14 lg:bottom-1/4 items-end">
          <div
            ...
            <p className="py-2">
              ...
              repellendus harum qui impedit voluptatem nemo ut dolores at! Ex
              quaerat quos deserunt dolor, earum eius nesciunt vel minima iste.
            </p>
            <button className="btn btn-xs sm:btn-sm md:btn-md border-none btn-primary ">
              BUY NOW
            </button>
          </div>
