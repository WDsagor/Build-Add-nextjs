...
const Certifide = () => {
  return (
    <div className="max-w-screen-2xl px-10 mx-auto py-5">
            ...
            <div className="card card-compact ">
              <figure className="p-8">
                <Image
                  ...
                  src="/images/certified/buet.jpeg"
                  alt="BUET"
                />
              </figure>
            </div>
            ...
            <div className="card card-compact ">
              <figure className="p-8">
                <Image
                  ...
                  height={200}
                  className="rounded-xl"
                  src="/images/certified/bcsir.jpg"
                  alt="BCSIR"
                />
              </figure>
            </div>
