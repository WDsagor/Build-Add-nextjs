              ...
              <form onSubmit={handleSubmit(onSubmit)} className=" ">
                <div className=" lg:grid lg:grid-flow-col lg:gap-3 ">
                  <div className="form-control">
                    ...
                    <input
                      ...
                      className="input input-bordered bg-transparent border-yellow-300 text-white mb-3"
                    />
                    {errors.fname?.type === "required" && (
                      <small className=" text-[#FFF80A] mt-1 self-end label-text-alt ">Frist name is required</small>
                    )}
                  </div>
                  <div className="form-control">
                    <label className="label ">
                    ...
                    {errors.lname?.type === "required" && (
                      <small className=" text-[#FFF80A] mt-1 self-end label-text-alt ">Last name is required</small>
                    )}
                  </div>
                </div>
                <div className="form-control">
                ...
                <div className="form-control">
                  ...
                  <textarea
                    ...
                    className="input h-36 input-bordered bg-transparent border-yellow-300 text-white mb-3"
                  />
                  {errors.massages?.type === "required" && (
                    <small className=" text-[#FFF80A] mt-1 self-end label-text-alt ">Write your massages</small>
                  )}
                </div>
